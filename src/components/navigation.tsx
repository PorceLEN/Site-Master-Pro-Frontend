        ...
        <div className="navigation__container">
          ...
          <div className="navigation__menu">
            ...
            <ul className="navigation__list">
              <li className="MENU produits">nos produits</li>
              <li className="MENU promos">les promos</li>
              <li className="MENU catalog">nos catalogues</li>
              <li className="MENU contact">nous contacter</li>
            </ul>
          </div>
